              ...
              var nro_boleta = params.get('boleta') || "10000";
              var nombre_cliente = params.get('cliente') || "NOMBRE CLIENTE";
              var usuario = params.get('usuario') || "USUARIO";
              var puntos = params.get('puntos') || "0";
              var telefono = params.get('telefono') || "999999999";
              var codigo_pais = params.get('codigo_pais') || "+";
              var fecha = params.get('fecha') || "31/05/2025 10:00:23";
              var fecha_entrega = params.get('fecha_entrega') || "31/05/2025 10:00:23";
              var total = params.get('total') || "100";
              var total_a_pagar = params.get('total_a_pagar') || "50";
              var descuento = params.get('descuento') || '0.00';
              var a_cuenta = params.get('a_cuenta') || "0";
              var desc_por_prenda = params.get('desc_por_prenda') || "0";
              var pagado_con = params.get('pagado_con') || "0";
              var a_cuenta_dos = params.get('a_cuenta_dos') || "0";
              var pagado_con_dos = params.get('pagado_con_dos') || "0";
              var porcent_desc = params.get('porcent_desc') || "0";
              var porcent_desc_plata = params.get('porcent_desc_plata') || "0";
              var total_por_pagar = params.get('total_por_pagar') || "0";
              var estado = params.get('estado') || "PAGADO";
              var total_prendas = params.get('total_prendas') || "10";
              var cantidades = params.get('cantidades') || "10";
              var descripciones = params.get('servicios') || "AL AGUA: SABANAS";
              var detalle = params.get('detalles') || "TERNO";
              var p_units = params.get('p_unit') || "15";
              var subtotal = params.get('subtotal') || "150";
              ...
              result.forEach(function (row) {
                  ...
                  newRow.innerHTML = `
                      ...
                      <td class="itemtab" style="text-align: right; font-size: 0.5mm;">
                          ${row.descripcion} ${row.detalle} ${row.precio_unit}
                      </td>
                      <td class="itemtab" style="text-align: right; font-size: 0.5mm;">
                          ${row.subtotal}
                      </td>
